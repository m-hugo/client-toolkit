...
impl LayerState {
    pub fn new() -> LayerState {
        LayerState { wlr_layer_shell: None, layers: Vec::new() }
    }
...
macro_rules! delegate_layer {
    ($ty: ty) => {
        $crate::reexports::client::delegate_dispatch!($ty: [
            $crate::reexports::protocols::unstable::wlr::unstable::layer_shell::v1::client::zwlr_layer_shell_v1::ZwlrLayerShellV1,
            $crate::reexports::protocols::unstable::wlr::unstable::layer_shell::v1::client::zwlr_layer_surface_v1::ZwlrLayerSurfaceV1
